...
public class XLSX2CSV {
    ...
    private class SheetToCSV implements SheetContentsHandler {
        ...
        public void cell(String cellReference, String formattedValue,
            ...
            currentRowList.add(formattedValue);
        }
    }
    ...
    public void process() throws IOException, OpenXML4JException, SAXException {
        ...
        while (iter.hasNext()) {
            try (InputStream stream = iter.next()) {
                ...
                List<List<String>> lists = sheetToCSV.getRows();
//                lists.forEach(v -> System.out.println(String.join(",", v)));
...
//        File xlsxFile = new File("large_excel_file/large-file-with-empty.xlsx");
        File xlsxFile = new File("large_excel_file/large-file.xlsx");
