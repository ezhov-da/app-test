...
public class AudioCapture01 extends JFrame {
    ...
    //Этот метод захватывает аудио с микрофона и сохраняет в объект ByteArrayOutputStream
    ...
    //Этот метод проигрывает аудио данные, которые были сохранены в ByteArrayOutputStream
    ...
    //Этот метод создает и возвращает объект AudioFormat
    ...
    class CaptureThread extends Thread {
        ...
        byte tempBuffer[] = new byte[240000];
...
//                        byteArrayOutputStream.write(tempBuffer, 0, cnt);
                            ...
                            if (recognizer.acceptWaveForm(tempBuffer, cnt)) {
                                System.out.println("getResult-" + recognizer.getResult());
                            } else {
//                                System.out.println("getPartialResult-" + recognizer.getPartialResult());
                            }

//                            System.out.println("getFinalResult-" + recognizer.getFinalResult());
                        }
                    }
                }
